...
define((require) => {
   ...
   */
  ModuleController.prototype.startLogicTimer = function () {
    var me = this;
   ...
   */
  ModuleController.prototype.newModule = function () {
   ...
   */
  ModuleController.prototype.loadModule = function (mod) {
   ...
   */
  ModuleController.prototype.createComponent = function (type, args) {
   ...
   */
  ModuleController.prototype.importModule = function (mod, bounds) {
   ...
   */
  ModuleController.prototype.refreshConnectors = function (component) {
   ...
   */
  ModuleController.prototype.addComponent = function (type, bounds) {
   ...
   */
  ModuleController.prototype.getConnectorMap = function () {
    var me = this;
    var map = {};
   ...
   */
  ModuleController.prototype.breakConnections = function (connector) {
    var me = this;
   ...
   */
  ModuleController.prototype.deleteComponent = function (mod, component) {
    var me = this;
