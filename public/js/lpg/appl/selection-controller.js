...
define((require) => {
  ...
  // Includes
  // 
  const EmptyState = require('appl/selection-states/empty-state');
  const HoverConnectorState = require('appl/selection-states/hover-connector-state');
  const HoverComponentState = require('appl/selection-states/hover-component-state');
  const PanningState = require('appl/selection-states/panning-state');
  const SelectingState = require('appl/selection-states/selecting-state');
  const DraggingState = require('appl/selection-states/dragging-state');
  const ConnectingState = require('appl/selection-states/connecting-state');
