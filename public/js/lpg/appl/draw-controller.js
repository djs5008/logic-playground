...
define(function () {
   ...
   */
  function DrawController(stage, selectionController, moduleController) {
    // setup properties
    this.stage = stage;
   ...
   */
  DrawController.prototype.fitStage = function () {
    var SIZE_RATIO = (3 / 4);
   ...
   */
  DrawController.prototype.startAnimationTimer = function () {
    var me = this;
   ...
   * Paint the canvas
   */
  DrawController.prototype.paint = function () {
    setTimeout(() => {
   ...
   */
  DrawController.prototype.drawBackground = function () {
   ...
   */
  DrawController.prototype.drawGrid = function () {
    const GRID_GAP = 50;
   ...
   */
  DrawController.prototype.drawOrigin = function () {
   ...
   */
  DrawController.prototype.drawComponents = function () {
    var me = this;
   ...
   */
  DrawController.prototype.drawHoveredComponent = function () {
   ...
   */
  DrawController.prototype.drawComponentSelections = function () {
    var me = this;
   ...
   */
  DrawController.prototype.drawHoveredConnector = function () {
   ...
   */
  DrawController.prototype.drawConnectorSelection = function () {
   ...
   */
  DrawController.prototype.drawSelection = function () {
   ...
   */
  DrawController.prototype.drawCurrentWire = function () {
    var selectedConnector = this.selectionController.getSelectedConnector();
    if (selectedConnector !== null) {
   ...
   */
  DrawController.prototype.drawAllWires = function () {
    var me = this;
    const FLOW_GAP = 10;
